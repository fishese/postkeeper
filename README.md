...
The published [0.6.1 preview](https://github.com/fishese/postkeeper/releases/tag/v0.6.1) adds a compact mobile library and reader, Settings sheets, reusable CSS tokens, and English localization resources. **Settings → About → Download for Android** links to the matching [signed APK](https://github.com/fishese/postkeeper/releases/download/v0.6.1/postkeeper-release.apk), hosted on GitHub. The [browser extension guide](https://keep.fishese.cc/extensions.html) provides versioned downloads and installation steps; fresh extension installs connect to the hosted PWA by default. See [UI and localization](docs/UI_AND_LOCALIZATION.md) for styling and future translation guidance. Milestone 7 remains untouched.
