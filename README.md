...
The 0.6.1 UI follow-up adds a compact mobile library and reader, Settings sheets, reusable CSS tokens, and English localization resources. **Settings → About → Download for Android** links to the matching signed GitHub APK. See [UI and localization](docs/UI_AND_LOCALIZATION.md) for styling and future translation guidance. Milestone 7 remains untouched.
