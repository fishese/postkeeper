...
The latest published preview is **web/native 0.6.4** (Android versionCode 10) and **extension 0.1.3**, source `157c819`. A tested hotfix is prepared as **web/native 0.6.5** (versionCode 11) and **extension 0.1.4** for long-running native capture, Reddit-style primary media, and Chromium mobile standalone-tab lookup. See [Current status and acceptance limits](docs/STATUS.md); Milestone 7 remains untouched.
