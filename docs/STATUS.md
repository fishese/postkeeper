...
2026-09-02 — The user authorized publishing the policy pages and application links to the existing GitHub Pages site. The release includes only the prepared policy, navigation, build/test, and documentation changes. Deployment verification is pending. Google OAuth remains in Testing; this release does not change audience settings or complete milestone 4 acceptance.
