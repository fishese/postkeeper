...
Mozilla returned a signed Firefox **0.1.5** XPI (**136,308 bytes**, SHA-256 `26d7d07bc89c303914fc6722644641804cf53188ed550479e2525edec414f304`). It contains Mozilla COSE and legacy signature metadata and retains the reviewed manifest version, extension ID, Firefox desktop 140+ minimum and Android 142+ minimum. The existing preview release and public install links are being updated to offer this signed XPI; the unsigned ZIP remains the reproducible AMO input.
...
| `postkeeper-firefox-0.1.5.xpi`  | 136,308 | `26d7d07bc89c303914fc6722644641804cf53188ed550479e2525edec414f304` |
...
Outputs are `apps/extension/build/chromium/postkeeper-0.1.5.zip` and `apps/extension/build/firefox/postkeeper-0.1.5.zip`. The versioned GitHub preview release is `extension-v0.1.5`; its public assets include the Chromium ZIP, unsigned Firefox source ZIP, Mozilla-signed Firefox XPI and `SHA256SUMS.txt`. Chromium desktop uses an extracted folder and Developer mode → Load unpacked. The signed XPI provides the normal Firefox desktop/Android installer; the unsigned ZIP remains available as the reproducible AMO submission input.
